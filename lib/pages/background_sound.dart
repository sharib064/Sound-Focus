...
class _BackgroundSoundState extends State<BackgroundSound> {
  final List songs = [
    ...
    ["Mantra", "lib/images/mantra.jpg", "Alex", "audio/mantra.ogg"],
    [
      "Sunset-landscape",
      "lib/images/Forest.jpg",
      "Keys of Moon",
      "audio/sunset-landscape.ogg"
    ],
    ["Winter-Spa", "lib/images/mantra.jpg", "Alex", "audio/Winter-spa.ogg"],
    ["Eternal-healing", "lib/images/Forest.jpg", "Alex", "audio/healing.ogg"],
    [
      "Deep Meditation",
      "lib/images/meditation.png",
      "David Fesliyan",
      "audio/meditation.ogg"
    ]
  ];
