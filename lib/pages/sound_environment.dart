...
class _SoundEnvironmentState extends State<SoundEnvironment> {
  ...
  final List<Map<String, dynamic>> iconData = [
    ...
    },
    {
      ...
      'ringtone-mp3': 'audio/tribal-drums.ogg',
    },
    {
